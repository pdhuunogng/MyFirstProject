...
Using this information, write a program that computes and stores the Fibonacci sequence in an integer array F, such that  F[i] will store the (i+1)th number in a Fibonacci sequence. The size of the array is an input parameter which is entered by the user.
